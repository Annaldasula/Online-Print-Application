...
#           run.font.bold = True
    ...
    sov_text = (
    "•f"Client {client_name}" and its peers collectively received a total of 5017 prominent news mentions online during the specified time period.\n"
    ...
    "•f"Client {client_name}" has received 239 all mentions and 44 prominent articles in online media and stands last in both the SOVs.\n"
        )
...
"•The  journalists reporting on IIT Ropar and not on its competitors are Navjeevan Gopal from The Indian Express with 1 article and Munieshwer A Sagar from TOI with 1 articles.\n",

 "•Top journalists covering competitors rather than IIT Ropar are Sukanya Nandy from News18 with 59 articles, followed by Hemali Chapia from TOI with 44 articles, and Suramya Sunilraj from News18 with 43 articles. \n"
"•These journalists have not written any articles on IIT Ropar so there is an opportunity for IIT Ropar to engage with these journalists to broaden its coverage and influence within the industry.\n"
                       ]
